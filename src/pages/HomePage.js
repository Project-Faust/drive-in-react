    ...
    >
      ...
      <div>
        <section className="d-flex flex-column align-items-center">
          ...
          >
            <h2>
              Please view our upated Menu & Rules Pages! <br /> There have been
            ...
            <div className="border border-secondary border-3 rounded bg-dark text-light">
              <div className="d-flex flex-column justify-content-evenly align-items-center p-3">
                <div>
                  ...
                  <h5 className="h3 py-1">
                    This includes both <strong>admission</strong> and{" "}
                ...
                <div className="border-top border-light">
                  <h4 className="h2 py-1">
                    We open the gates for parking spots at{" "}
                    <strong>6:00PM</strong>!
                  </h4>
                  <h5 className="h3 py-1">
                    Our first movie starts at <strong>SUNDOWN</strong>!
                  </h5>
                </div>
                <div className="border-top border-light">
                  <h4 className="h2 py-1">
                    ...
                    <strong>
                      <u>portable FM radio</u>!
                    </strong>
                  </h4>
                  <h5 className="h3 pt-1 pb-3">
                    Unfortunately, radio apps on mobile devices{" "}
                    <strong>
                      <u>do not work</u>
                    </strong>
                    !
                ...
                <h4 className="h2 py-3">
                  <strong>
                    Find us at{" "}
                    <a href="#google-map-embed">
                      314 McAdenville Rd, Belmont, NC 28012
                    </a>
                  </strong>
                </h4>
                <div className="row">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <ul className="text-start shadow-2b p-3 m-3">
                        ...
                        <li>
                          Admission is <strong>$25 per carload</strong>.<br />
                          After leaving, you must pay to reenter.
                        </li>
                        <li>
                          Our business runs and survives on sales from the
                          concession stand!
                          <br /> <strong>No outside food or drink!</strong>
                        </li>
                        <li>
                          Alongside not bringing outside food and drink, we have
                          a <strong>zero-tolerance no alcohol policy</strong>.
                        </li>
                        <li>
                          All of our sound, including music, movie sound, and
                          announcements, is broadcast locally on{" "}
                          <strong>FM Radio!</strong>
                          <br />
                          <strong>Please bring a portable FM radio</strong> if
                          you are unable to turn off all vehicle lights while
                          the engine is off!
                        </li>
                        <li>
                          Please <strong>leave pets at home</strong>!
                        </li>
                        <li>
                          Once the field lights are dimmed, please{" "}
                          <strong>turn off all exterior vehicle lights</strong>!
                          <br />
                          Please come prepared to promptly extinguish your
                          lights!
                        </li>
                      </ul>
                    </div>
                  ...
                  >
                    ...
                    <h5 className="h3 remember-header shadow-2b">
                      <strong>5/1/2026 & 5/2/2026</strong>
                    </h5>

                    <p className="h3 text-light text-start text-center p-3">
                      <strong>The Devil Wears Prada 2</strong>
                      <br />
                      followed by
                      <br />
                      <strong>Ready or Not 2: Here I come</strong>
                    </p>
      ...
      <section>
        <div
          id="google-map-embed"
          className="d-flex justify-content-center align-items-center mx-3 mt-3 mw-100"
        >
          <iframe
